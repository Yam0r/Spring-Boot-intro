...
@Tag(name = "Category management", description = "Endpoints for managing categories in the bookshop")
...
public class CategoryController {
    ...
    @PostMapping
    @Operation(summary = "Create a new category", description = "Create a new category for books in the system")
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    @GetMapping("/{id}/books")
    @Operation(summary = "Get books by category", description = "Retrieve all books that belong to a specific category")
    public List<BookDto> getBooksByCategoryId(@Parameter(description = "ID of the category to get books from")
                                              @PathVariable Long id) {
